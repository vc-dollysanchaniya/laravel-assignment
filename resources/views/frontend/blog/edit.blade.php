                                            ...
                                            <section id="toolbar">
                                                ...
                                                <div class="float-right">
                                                    <div class="col-3 pl-0">
                                                        <span class="switch">
                                                            <label>
                                                                <input type="checkbox" class="status" name="status" value="1" @checked($blog->status == \App\Constant\Constant::STATUS_ONE) />
                                                                <span></span>
                                                            </label>
                                                        </span>
                                                    </div>
...
@section('after-scripts')
    ...
    <script src="{{ asset('js/pages/custom/blog/edit-blog.js') }}"></script>
@endsection